...
print("Converting Image To Cube!! (It Should Take I A Minute, Please Do Not Close This Windows!!)")
    ...
    for row in range(3):
        for col in range(4):
            if name_map[row][col] != "":
                ...
                filelist.append(fn)
                imgOut.crop((sx, sy, sx + cube_size, sy + cube_size)).resize((256, 256)).save(tempdir+str(cspr)+fn)
                os.system('cls')
